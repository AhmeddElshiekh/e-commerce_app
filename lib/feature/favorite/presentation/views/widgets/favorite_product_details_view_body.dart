...
import 'package:smile_shop/feature/favorite/presentation/views/widgets/favorite_product_details_image.dart';

class FavoriteProductDetailsViewBody extends StatelessWidget {
  const FavoriteProductDetailsViewBody({super.key, required this.model});
  final Product model;
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      FavoriteProductDetailsImages(model: model),
                      const SizedBox(
                        height: 10,
                      ),
                      Text(
