...
import 'package:smile_shop/feature/cart/presentation/views/widgets/cart_product_details_images.dart';

class CartProductDetailsViewBody extends StatelessWidget {
  const CartProductDetailsViewBody({super.key, required this.model});
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      CartProductDetailsImages(model: model),
                      const SizedBox(
                        height: 10,
                      ),
                      Text(
